            ...
            <form class="" action="{{ route('seller.shop.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-10">
                        <input type="email" class="form-control mb-3" placeholder="{{ translate('Email')}}" name="email" value="{{ $shop->email }}" required>
                    </div>
                </div>

                  <div class="row">
                    <label class="col-md-2 col-form-label">{{ translate('Website') }} <span class="text-success text-success">(if available)</span></label>
                    <div class="col-md-10">
                        <input type="text" class="form-control mb-3" placeholder="{{ translate('Website')}}" name="Website" value="{{ $shop->Website }}" >
                    </div>
                </div>
