        ...
        <div class="container">
            ...
            @if ($todays_deal_banner != null || $todays_deal_banner_small != null)
                <div class="mb-4 overflow-hidden hov-scale-img d-none d-md-block">
                    <img src="{{ uploaded_asset($todays_deal_banner) }}" 
                        data-src="{{ uploaded_asset($todays_deal_banner) }}" 
                        alt="{{ env('APP_NAME') }} promo" loading="lazy" class="img-fit h-100 has-transition" 
                        onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';">
                </div>
                <div class="mb-4 overflow-hidden hov-scale-img d-md-none">
                    <img src="{{ $todays_deal_banner_small != null ? uploaded_asset($todays_deal_banner_small) : uploaded_asset($todays_deal_banner) }}" 
