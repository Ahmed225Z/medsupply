...
<head>
    ...
    src: url('{{static_asset('assets/fonts/HelveticaNeueLTProBd.otf')}}') format('woff2'),
         url('{{static_asset('assets/fonts/HelveticaNeueLTProBdCn.otf')}}') format('woff');
    font-weight: 400;
    font-style: normal;
...
body {
    font-family: 'HelveticaNeueLTProBlkCnO', sans-serif;
    font-weight: 400;
}
...
<body>
    ...
    {{--    <script
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.16.0/popper.min.js" integrity="sha512-6hAnUCXfhaIhBbAywqfu7GUK3WclxywpqQaE8vvz2/kZbnmXg8Qd0VsQyL3LXh0pgNg9tnJ0JCT32w9BiR/E5A==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/23.3.2/js/intlTelInput.min.js" integrity="sha512-bI8p+N2aasTuJLy8AvOiz95alTQXMydtqK5cNOqqIraDXZUQwwQyJ6cadLKHyIT2CkSQ2lItDC1xHKrhjKRlJw==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
        ...
        <script src="
    https://cdn.jsdelivr.net/npm/@enact/spotlight@4.9.0-beta.1/Pause/Pause.min.js
    "></script>
    ...
    "></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-countdown/1.6.1/jquery.countdown.min.js" integrity="sha512-aX4zt/paM2D/HNArfcRPVdamZ2tIO/L/+O3CyqtayFHc84eQ3+kA5u95+SwrA0MqAYGqfu+KTcnAG7AdBatSUQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    "></script>
        ...
        <script src="
    https://cdn.jsdelivr.net/npm/slick-slider@1.8.2/slick/slick.min.js
    "></script>
        <link href="
    https://cdn.jsdelivr.net/npm/slick-slider@1.8.2/slick/slick.min.css
    " rel="stylesheet">
        ...
        <script src="
    https://cdn.jsdelivr.net/npm/terser@5.31.3/dist/bundle.min.js
    "></script>
    --}}
