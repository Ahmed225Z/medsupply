...
<section class="py-3 text-light footer-widget border-bottom px-lg-3"
        ...
        <div class="mt-3 mb-4">
            <a href="{{ route('home') }}" class="d-block">
                @if (get_setting('footer_logo') != null)
                    <img class="h-18px" src="{{ uploaded_asset(get_setting('footer_logo')) }}"
                        data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}"
                        height="18" loading="lazy">
                @else
                    <img class="h-50px" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                        data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}"
                        ...
                        <div class="row gutters-10">
                            ...
                            <div class="col-4">
                                <button type="submit" class="btn btn-primary  w-50 "
                                    style="background-color: white;color:rgb(136, 79, 79)">{{ translate('Subscribe') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
...
@php
    $col_values =
        get_setting('vendor_system_activation') == 1 || addon_is_activated('delivery_boy')
            ...
            : 'col-md-4 col-sm-6';
@endphp
<section class="py-lg-3 text-light footer-widget px-lg-3" style="background-color: #212129 !important;">
                                ...
                                <li class="mb-2">
                                    <p class="fs-13 text-soft-light mb-0">
                                        ...
                                        <a href="{{ route('shops.create') }}"
                                            class="fs-13 fw-700 ml-2 text-soft-light">{{ translate('Apply Now') }}</a>
                                    </p>
                                </li>
                                @guest
                                    <li class="mb-2">
