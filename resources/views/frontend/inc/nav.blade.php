        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col">
                    <ul
                        class="list-inline d-flex align-items-center justify-content-between justify-content-lg-start mb-0">
                        <!-- Language switcher -->
        ...
        <div class="position-relative logo-bar-area border-bottom border-md-nonea z-1025">
            <div class="container">
                <div class="d-flex align-items-center">
                        ...
                        <a class="d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                            ...
                            @if ($header_logo != null)
                                <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}"
                                    class="mw-100 h-18px h-md-18px" height="18">
                            @else
                    ...
                    @endif
                    <div class="cuurency d-flex">
                        <a class=" dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            aria-expanded="false">
                            <img style="width: 22px; height: 15px"
                                src="{{ static_asset('assets/img/flags/ae.png') }}" alt="United Arab Emarites">
                        </a>


                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item ts" href="https://ae.med-supplys.com"><img
                                        src="{{ static_asset('assets/img/flags/ae.png') }}"
                                        alt="United Arab Emarites" style="width: 17px; height: 12px"> United Arab Emirates</a></li>
                            <li><a class="dropdown-item ts" href="https://main.med-supplys.com"><img
                                        src="{{ static_asset('assets/img/flags/um.png') }}"
                                        alt="United Arab Emarites" style="width: 17px; height: 12px"> United States of America</a></li>
                        </ul>
                    </div>
                ...
                <div class="d-flex h-100">
                    ...
                    <div class="ml-xl-4 w-100 overflow-hidden">
                        <div class="d-flex  justify-content-center" style="height: 50px">
                            ...
                            {{--                                        @if ($loop->index == 0) --}}
                            {{--                                            <span class="mr-4"><i class="las la-angle-left" --}}
                            {{--                                                    style="font-size: 16px; color: #fff "></i></span> --}}
                            {{--                                        @endif --}}
                            ...
                            {{--                                                <span class="m-1"> --}}
                            {{--                                                    <img src="{{ uploaded_asset(json_decode(get_setting('header_menu_images'), true)[$key]) }}" style="img-fit h-100"> --}}
                            {{--                                                </span> --}}
                            {{--                                                {{ translate($value) }} --}}
                            {{--                                            </a> --}}
                            {{--                                        </li> --}}
                            {{--                                        @if ($loop->index == sizeof(json_decode(get_setting('header_menu_links'))) - 1) --}}
                            {{--                                            <span class="ml-4"><i class="las la-angle-right" --}}
                            {{--                                                    style="font-size: 16px; color: #fff; "></i></span> --}}
                            {{--                                        @endif --}}
                            {{--                                    @endforeach --}}
                            {{--                                @endif --}}
                            ...
                            <div class="c-scrollbar-light mx-10" style="width: 95% !important;">
                                <div class="h-100 d-flex flex-column justify-content-center">
                                    <div class="todays-deal aiz-carousel" data-items="7" data-xxl-items="7"
                                        data-xl-items="6" data-lg-items="6" data-md-items="4" data-sm-items="3"
                                        data-xs-items="2" data-arrows="true" data-dots="false" data-autoplay="false"
                                        data-infinite="true">
                                        @foreach (json_decode(get_setting('header_menu_labels'), true) as $key => $value)
                                            <div class="carousel-box h-100 px-3 px-lg-0">
                                                <li class="list-inline-item mr-0 animate-underline-white w-100">
                                                    <a href="{{ json_decode(get_setting('header_menu_links'), true)[$key] }}"
                                                        class="fs-13 d-flex justify-content-center fw-700 {{ $nav_txt_color }} align-items-center header_menu_links hov-bg-black-10 w-100
                                                        @if (url()->current() == json_decode(get_setting('header_menu_links'), true)[$key]) active @endif">

                                                        <span class="m-1">
                                                            <img src="{{ uploaded_asset(json_decode(get_setting('header_menu_images'), true)[$key]) }}"
                                                                style="img-fit h-100">
                                                        </span>
                                                        <span class="m-1">{{ translate($value) }}</span>
                                                    </a>
                                                </li>
