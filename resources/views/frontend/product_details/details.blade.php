<div class="text-left">
    ...
    @else
        ...
        @else
            <!-- Without Wholesale -->
            @if (home_price($detailedProduct) != home_discounted_price($detailedProduct) && auth()->check())
                <div class="row no-gutters mb-3">
                    <div class="col-sm-2">
            ...
            @if (auth()->check())
                ...
                <div class="row no-gutters mb-3">
                    ...
                    <div class="col-sm-10">
                        <div class="d-flex align-items-center">
                            ...
                            <!-- Unit -->
                            @if ($detailedProduct->unit != null && auth()->check())
                                <span class="opacity-70">/{{ $detailedProduct->getTranslation('unit') }}</span>
                            @endif
                            <!-- Club Point -->
                            @if (addon_is_activated('club_point') && $detailedProduct->earn_point > 0)
                ...
                <div class="row no-gutters mt-3">
                    <div class="col-12">
                        <div class="text-secondary fs-14 fw-400">{{ translate('Please login to see the price')}}</div>
                    </div>
                </div>
            @endif
            @endif
