    ...
    <div class="p-2 p-md-3 text-left">
        ...
        <div class="fs-14 d-flex justify-content-center mt-3">
            @if ($product->auction_product == 0)
                ...
                @if(auth()->check())
                    <div class="">
                        <span class="fw-700" style="color: #0a0a0a !important;">{{ home_discounted_base_price($product) }}</span>
                    </div>
                @else
                    <div class="">
                        <span class="fw-700" style="color: #0a0a0a !important;">{{ translate('Login to see price') }}</span>
                    </div>
                @endif
            @endif
            @if ($product->auction_product == 1)
