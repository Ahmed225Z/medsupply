                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        @can('club_point_configurations')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('Ranks.index') }}" class="aiz-side-nav-link">
                        ...
                        @can('set_club_points')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('show.convert.points') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['set_product_points', 'product_club_point.edit']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Set  Point Currency') }}</span>
                                </a>
                            </li>
                        @endcan
                ...
                @canany(['header_setup', 'footer_setup', 'view_all_website_pages', 'website_appearance',
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endcan
                            @can('authentication_settings')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('website.authentication-settings') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Authentication Settings') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('header_setup')
