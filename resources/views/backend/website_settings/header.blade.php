				...
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="border-top pt-3">
						...
						<div class="header-nav-menu">
							...
							<input type="hidden" name="types[]" value="header_menu_images">
									...
									<div class="row gutters-5">
                                        <div class="col-md-5">
                                            <div class=" input-group " data-toggle="aizuploader" data-type="image">
                                                ...
                                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                                <input type="hidden" name="header_menu_images[]" class="selected-files" value="{{ json_decode(App\Models\BusinessSetting::where('type', 'header_menu_images')->first()->value, true)[$key] }}">
                                            </div>
                                            <div class="file-preview"></div>
                                        </div>
										<div class="col-4">
							...
							data-content='<div class="row gutters-5">
                                ...
                                <div class="col-md-5">
                                    <div class=" input-group " data-toggle="aizuploader" data-type="image">
                                        ...
                                        <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                        <input type="hidden" name="header_menu_images[]" class="selected-files" value="">
                                    </div>
                                    <div class="file-preview"></div>
                                </div>
								<div class="col-4">
