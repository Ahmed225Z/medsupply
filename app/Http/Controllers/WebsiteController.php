...
class WebsiteController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware(['permission:authentication_settings'])->only('authentication_settings');
    }
    ...
    public function authentication_settings(Request $request)
    {
        return view('backend.website_settings.authentication_settings');
    }
}
