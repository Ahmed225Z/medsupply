...
class AuthController extends Controller
{
    public function signup(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            ], 500);  // تغيير حالة الاستجابة إلى 500
        }
        ...
        if ($user->email_verified_at == null) {
            if ($request->register_by == 'email') {
                ...
                // Instead of OTP verification, just log a message or perform a different action
                // Log::info('OTP verification skipped for user: ' . $user->id);
            }
        }
