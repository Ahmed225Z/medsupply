...
use App\Http\Controllers\ConvertPointController;
...
//Update Routes
// routes/web.php
Route::post('/users/toggle-approve', [HomeController::class, 'toggleApprove'])->name('users.toggleApprove');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    Route::get('/show/convert/point', [ConvertPointController::class, 'index'])->name('show.convert.points');
    Route::Post('/convert/point', [ConvertPointController::class, 'store'])->name('store.convert.points');
    Route::put('/convert/point/update', [ConvertPointController::class, 'UpdateConvertPoint'])->name('update.convert.points');
    // Language
    ...
    Route::group(['prefix' => 'website'], function () {
        Route::controller(WebsiteController::class)->group(function () {
            ...
            Route::get('/authentication-settings', 'authentication_settings')->name('website.authentication-settings');
