...
Route::get('download-license/{id}', [HomeController::class, 'downloadLicense'])->name('users.download_license');
Route::get('/approval-wait', function () {
...
Route::group(['middleware' => ['user', 'verified', 'unbanned','checkApproval']], function () {
