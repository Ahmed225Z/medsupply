...
Route::group(['middleware' => ['user', 'verified']], function () {
    Route::controller(ClubPointController::class)->group(function () {
        ...
        Route::post('convert-point-into-wallet/{id}', 'convert_into_wallet')->name('convert_into_wallet');
        Route::post('convert-point-into-wallet', 'convert_points_into_wallet')->name('convert_points_into_wallet');
    });
});
