...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::middleware('auth:sanctum')->controller(CartController::class)->group(function () {
        ...
        Route::post('carts/list', [CartController::class, 'getList']); // مسار جديد لطلب POST
    ...
    Route::get('coupon-section', 'App\Http\Controllers\Api\V2\CouponController@couponDetails');
    ...
    Route::group(['middleware' => ['app_user_unbanned']], function () {
        ...
        Route::delete('user/shipping/delete/{address_id}', 'App\Http\Controllers\Api\V2\AddressController@deleteShippingAddress')->middleware('auth:sanctum');

        Route::get('clubpoint/get-list', 'App\Http\Controllers\Api\V2\ClubpointController@get_list')->middleware('auth:sanctum');
        Route::post('Systempoint/convert-into-wallet', 'App\Http\Controllers\Api\V2\ClubpointController@convert_system_point_into_wallet')->middleware('auth:sanctum');
    ...
    Route::get('coupons/list-with-products', [CouponController::class, 'couponListWithProducts'])->name('api.coupons.list_with_products');
    ...
    Route::get('brands/top/home', 'App\Http\Controllers\Api\V2\BrandController@topHome');
    ...
    Route::get(
        ...
        'App\Http\Controllers\Api\V2\CategoryController@featuredHome'
    );
    Route::get('categories/all', [CategoryController::class, 'allCategories'])->name('api.categories.all');

    Route::get('categories/level', 'App\Http\Controllers\Api\V2\CategoryController@level');
    ...
    Route::get('todays-deal', 'App\Http\Controllers\Api\V2\ProductController@todaysDealDetails');

    Route::get(
        'products/featured/home',
        'App\Http\Controllers\Api\V2\ProductController@featuredHome'
    );
    ...
    //Route::get('products/all', 'App\Http\Controllers\Api\V2\ProductController@AllProduct');
    ...
    Route::get('products/category/{id}', 'App\Http\Controllers\Api\V2\ProductController@categoryProducts')->name('api.products.categories');
    ...
    Route::get('products/stocks/price', [ProductController::class,'getStocksPrice']);
    ...
    Route::get('newProduct', [ProductController::class, 'index'])->name('newsofproduct');
    Route::get('product/detail/{id}', [ProductController::class, 'showProduct']);
    ...
    Route::get('header-menu', 'App\Http\Controllers\Api\V2\SliderController@headerMenu');
    ...
    Route::get('header-logo', 'App\Http\Controllers\Api\V2\SliderController@headerLogo');
    ...
    Route::get('flash-deals/home', 'App\Http\Controllers\Api\V2\FlashDealController@flashdeal');
    ...
    Route::get('footer', 'App\Http\Controllers\Api\V2\FooterController@info');
